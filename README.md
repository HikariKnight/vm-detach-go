...
You can find all the valid keys [here](https://msdn.microsoft.com/en-us/library/windows/desktop/dd375731(v=vs.85).aspx) (just remove **VK_** from the button name so in order to use the spacebar you would type just **space** instead of **vk_space**)<br>
> NOTE: all values after the = sign in hotkeys.ini are case-insensitive.
